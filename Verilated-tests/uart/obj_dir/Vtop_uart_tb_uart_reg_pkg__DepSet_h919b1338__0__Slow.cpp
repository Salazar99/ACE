...
VL_ATTR_COLD void Vtop_uart_tb_uart_reg_pkg___ctor_var_reset(Vtop_uart_tb_uart_reg_pkg* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop_uart_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtop_uart_tb_uart_reg_pkg___ctor_var_reset\n"); );
