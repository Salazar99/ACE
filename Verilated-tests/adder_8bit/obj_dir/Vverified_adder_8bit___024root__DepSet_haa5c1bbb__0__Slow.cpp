...
VL_ATTR_COLD void Vverified_adder_8bit___024root___eval_triggers__stl(Vverified_adder_8bit___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vverified_adder_8bit___024root___eval_triggers__stl\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__VstlTriggered.set(0U, (IData)(vlSelfRef.__VstlFirstIteration));
    vlSelfRef.__VstlTriggered.set(1U, ((IData)(vlSelfRef.verified_adder_8bit__DOT__c) 
                                       != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__verified_adder_8bit__DOT__c__0)));
