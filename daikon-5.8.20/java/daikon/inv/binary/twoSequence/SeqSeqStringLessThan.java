...

{
  ...
  protected SeqSeqStringLessThan(PptSlice ppt, boolean orderMatters) {
    super(ppt);
    this.orderMatters = orderMatters;
  }

  protected @Prototype SeqSeqStringLessThan(boolean orderMatters) {
    super();
    this.orderMatters = orderMatters;
  }
  ...
  @Override
  public @Nullable @NonPrototype SeqSeqStringLessThan merge(
      @Prototype SeqSeqStringLessThan this, List<@NonPrototype Invariant> invs, PptSlice parent_ppt) {
    // Ignore the orderMatters field, because it is always the same (and is always true).
    return (SeqSeqStringLessThan) super.merge(invs, parent_ppt);
  }
}
