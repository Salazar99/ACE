...

{
  ...
  protected SeqSeqStringGreaterEqual(PptSlice ppt, boolean orderMatters) {
    super(ppt);
    this.orderMatters = orderMatters;
  }

  protected @Prototype SeqSeqStringGreaterEqual(boolean orderMatters) {
    super();
    this.orderMatters = orderMatters;
  }
  ...
  @Override
  public @Nullable @NonPrototype SeqSeqStringGreaterEqual merge(
      @Prototype SeqSeqStringGreaterEqual this, List<@NonPrototype Invariant> invs, PptSlice parent_ppt) {
    // Ignore the orderMatters field, because it is always the same (and is always true).
    return (SeqSeqStringGreaterEqual) super.merge(invs, parent_ppt);
  }
}
