...

{
  ...
  protected SeqSeqStringGreaterThan(PptSlice ppt, boolean orderMatters) {
    super(ppt);
    this.orderMatters = orderMatters;
  }

  protected @Prototype SeqSeqStringGreaterThan(boolean orderMatters) {
    super();
    this.orderMatters = orderMatters;
  }
  ...
  @Override
  public @Nullable @NonPrototype SeqSeqStringGreaterThan merge(
      @Prototype SeqSeqStringGreaterThan this, List<@NonPrototype Invariant> invs, PptSlice parent_ppt) {
    // Ignore the orderMatters field, because it is always the same (and is always true).
    return (SeqSeqStringGreaterThan) super.merge(invs, parent_ppt);
  }
}
