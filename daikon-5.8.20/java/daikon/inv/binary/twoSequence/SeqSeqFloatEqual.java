 ...
 */
public class SeqSeqFloatEqual extends TwoSequenceFloat
...

{
  ...
  protected SeqSeqFloatEqual(PptSlice ppt, boolean orderMatters) {
    super(ppt);
    this.orderMatters = orderMatters;
  }

  protected @Prototype SeqSeqFloatEqual(boolean orderMatters) {
    super();
    this.orderMatters = orderMatters;
  }
  ...
  @Override
  public @Nullable @NonPrototype SeqSeqFloatEqual merge(
      @Prototype SeqSeqFloatEqual this, List<@NonPrototype Invariant> invs, PptSlice parent_ppt) {
    // Ignore the orderMatters field, because it is always the same (and is always true).
    return (SeqSeqFloatEqual) super.merge(invs, parent_ppt);
  }
}
