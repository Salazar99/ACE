...

{
  ...
  protected SeqSeqStringEqual(PptSlice ppt, boolean orderMatters) {
    super(ppt);
    this.orderMatters = orderMatters;
  }

  protected @Prototype SeqSeqStringEqual(boolean orderMatters) {
    super();
    this.orderMatters = orderMatters;
  }
  ...
  @Override
  public @Nullable @NonPrototype SeqSeqStringEqual merge(
      @Prototype SeqSeqStringEqual this, List<@NonPrototype Invariant> invs, PptSlice parent_ppt) {
    // Ignore the orderMatters field, because it is always the same (and is always true).
    return (SeqSeqStringEqual) super.merge(invs, parent_ppt);
  }
}
