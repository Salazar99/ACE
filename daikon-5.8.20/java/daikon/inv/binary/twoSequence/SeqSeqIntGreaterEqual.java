 ...
 */
public class SeqSeqIntGreaterEqual extends TwoSequence

{
  ...
  protected SeqSeqIntGreaterEqual(PptSlice ppt, boolean orderMatters) {
    super(ppt);
    this.orderMatters = orderMatters;
  }

  protected @Prototype SeqSeqIntGreaterEqual(boolean orderMatters) {
    super();
    this.orderMatters = orderMatters;
  }
  ...
  public String repr(@GuardSatisfied SeqSeqIntGreaterEqual this) {
    return "SeqSeqIntGreaterEqual" + varNames() + ": ,orderMatters=" + orderMatters
  ...
  public @Nullable DiscardInfo isObviousDynamically(VarInfo[] vis) {
    ...
    assert ppt != null;
      ...
      if (ppt.parent.check_implied(di, vis[0], vis[1], PairwiseIntGreaterEqual.get_proto())) {
  ...
  public @Nullable NISuppressionSet get_ni_suppressions() {
    ...
    private static NISuppressee suppressee = new NISuppressee(SeqSeqIntGreaterEqual.class, 2);

    // Suppressor definitions (used in suppressions below)
    private static NISuppressor v1_pw_v2 = new NISuppressor(0, 1, PairwiseIntGreaterEqual.class);
  ...
  @Override
  public @Nullable @NonPrototype SeqSeqIntGreaterEqual merge(
      @Prototype SeqSeqIntGreaterEqual this, List<@NonPrototype Invariant> invs, PptSlice parent_ppt) {
    // Ignore the orderMatters field, because it is always the same (and is always true).
    return (SeqSeqIntGreaterEqual) super.merge(invs, parent_ppt);
  }
}
