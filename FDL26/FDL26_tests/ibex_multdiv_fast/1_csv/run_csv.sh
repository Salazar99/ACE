...
$ACEROOT/third_party/vcd2csv --vcd $ACEROOT/Designs/ibex_multdiv_fast/ibex_multdiv_fast.vcd --clk clk_i --vcd-ss tb_ibex_multdiv_fast::dut --dump-to ./ibex_multdiv_fast.csv
