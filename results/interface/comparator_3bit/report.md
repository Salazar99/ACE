...
### Guarantees
- `G(A > B |-> (A_greater == 1))` (propositional)
- `G(A > B |-> (A_equal == 0))` (propositional)
- `G(A > B |-> (A_less == 0))` (propositional)
- `G((A == 0) |-> A_equal >= A)` (temporal)
- `G((A == 0) |-> A_greater * 2 <= A)` (temporal)
...
- `G((A == 2) |-> A_greater * 2 <= A)` (temporal)
- `G((A == 3) |-> A_greater * 2 <= A)` (temporal)
- `G((A == 4) |-> A_greater * 2 <= A)` (temporal)
- `G((A == 5) |-> A_greater * 2 <= A)` (temporal)
- `G((A == 6) |-> A_greater * 2 <= A)` (temporal)
- `G((A == 7) |-> A_greater * 2 <= A)` (temporal)
- `G((A == 7) |-> A_less * B <= A)` (temporal)
- `G((A_equal) |-> A_greater * 2 <= A)` (temporal)
...
- `G((B == 0) |-> A_less * 2 <= A)` (temporal)
- `G((B == 0) |-> A_less * B <= A)` (temporal)
- `G((B == 0) |-> A_less <= A)` (temporal)
...
- `G(B >= 1 && B <= 7 |-> A_equal <= A)` (temporal)
- `G(B >= 1 && B <= 7 |-> A_equal <= B)` (temporal)
- `G(B >= 1 && B <= 7 |-> A_greater * 2 <= A)` (temporal)
- `G(B >= 1 && B <= 7 |-> A_greater <= B)` (temporal)
- `G(A >= 2 && A <= 7 |-> A_equal * 2 <= A)` (temporal)
- `G(A >= 2 && A <= 7 |-> A_less * 2 <= A)` (temporal)
- `G(B >= 2 && B <= 7 |-> A_equal * 2 <= A)` (temporal)
...
- `G((A == 5) |-> A_greater * 2 <= A)` (temporal)
- `G((A == 6) |-> A_greater * 2 <= A)` (temporal)
- `G((A == 7) |-> A_equal < B)` (temporal)
- `G((A == 7) |-> A_less * B <= A)` (temporal)
- `G((A == 7) |-> A_less < B)` (temporal)
- `G((A_equal) |-> A_greater * 2 <= A)` (temporal)
- `G((A_equal) |-> A_greater <= B)` (temporal)
- `G((A_equal) |-> A_greater == (A ^ B))` (temporal)
- `G((A_equal) |-> A_greater == A - B)` (temporal)
