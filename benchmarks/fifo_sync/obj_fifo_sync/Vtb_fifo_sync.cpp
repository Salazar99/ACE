...
VL_ATTR_COLD void Vtb_fifo_sync::trace(VerilatedVcdC* tfp, int levels, int options) {
    vl_fatal(__FILE__, __LINE__, __FILE__,"'Vtb_fifo_sync::trace()' called on model that was Verilated without --trace option");
}
