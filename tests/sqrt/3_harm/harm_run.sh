...
mv ./harm_res/default_ass.txt ./harm_res/sqrt_calculator_fault_out_0.txt
 harm --csv ./Detection_traces/sqrt_calculator_fault_out1_DU.csv --conf ./conf/sqrt_calculator_fault_out_1.xml --dump-to ./harm_res
 mv ./harm_res/default_ass.txt ./harm_res/sqrt_calculator_fault_out_1.txt
 ...
 mv ./harm_res/default_ass.txt ./harm_res/sqrt_calculator_fault_error_0.txt
